...
async def get_weather_data(data:device_data_model.WeatherDeviceData,client_id,device):
    try:
        ...
        value = f"{client_id}, {device_id}, '{device}',{data.TW}, {data.C1}, {data.C4}, {0.00}, {data.C3}, {data.C6}, {data.C2}, {data.C4}, {data.C5}, {0.00}, '{formatted_date}', '{formatted_time}', '{current_datetime}'"
